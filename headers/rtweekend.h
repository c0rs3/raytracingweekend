...
const float RINFINITY = std::numeric_limits<float>::infinity();
static constexpr float uint32d_limit = static_cast<float>(UINT32_MAX);
static constexpr float pi = 3.1415926535897932385f;

// Utility Functions

constexpr inline uint32_t map(uint32_t x, uint32_t in_min, uint32_t in_max, uint32_t out_min, uint32_t out_max) {
